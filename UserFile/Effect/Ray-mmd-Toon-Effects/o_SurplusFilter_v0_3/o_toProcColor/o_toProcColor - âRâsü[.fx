...
//　初期定義
 ...
 #define RGB_CYAN		float3(         0, 0.770588235, 0.770588235)
 #define RGB_MAGENTA	float3(0.696078435,          0, 0.696078435)
 #define RGB_YELLOW		float3(0.97254902, 0.97254902,          0)

 #define RGB_RED		float3(0.90196078, 0.03529412, 0.03529412)
 #define RGB_GREEN		float3(0.133333335, 0.60000000, 0.133333335)
 #define RGB_BLUE		float3(0.119607845, 0.119607845, 0.53333333)
