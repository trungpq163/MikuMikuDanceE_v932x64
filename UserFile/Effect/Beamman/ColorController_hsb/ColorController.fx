...
float morph_h : CONTROLOBJECT < string name = "ColorController.pmd"; string item = "乗算色相"; >;
float morph_s : CONTROLOBJECT < string name = "ColorController.pmd"; string item = "乗算彩度"; >;
float morph_b : CONTROLOBJECT < string name = "ColorController.pmd"; string item = "乗算明度"; >;
float morph_h_add : CONTROLOBJECT < string name = "ColorController.pmd"; string item = "加算色相"; >;
float morph_s_add : CONTROLOBJECT < string name = "ColorController.pmd"; string item = "加算彩度"; >;
float morph_b_add : CONTROLOBJECT < string name = "ColorController.pmd"; string item = "加算明度"; >;
...
float4 ColorRender_PS() : COLOR
{
    ...
    //加算
	pallet = tex2D(PalletSamp,float2(morph_h_add,1-morph_s_add))*morph_b_add;
