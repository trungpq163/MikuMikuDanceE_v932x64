...
VS_OUTPUT SmokeVS(float4 Pos: POSITION){
   ...
   if(MaterialDiffuse.a != 0 && MaterialDiffuse.a != 1)
   {
   		Out = AllFunc(SmokeNum,Pos,1,1,0,0.1,0);
   }
   return Out;
}
VS_OUTPUT SmokeHiSpeedVS(float4 Pos: POSITION){
   ...
   if(MaterialDiffuse.a != 0 && MaterialDiffuse.a != 1)
   {
   		Out = AllFunc(SmokeNum,Pos,0.75,5,0.8,0.1,0);
   }
   return Out;
}
VS_OUTPUT FireVS(float4 Pos: POSITION){
   ...
   if(MaterialDiffuse.a != 0 && MaterialDiffuse.a != 1)
   {
   		Out = AllFunc(FireNum,Pos,1.5,0.5,0.75,0.25,0);
	    Out.texCoord.x += 0.5;
   }
   return Out;
}
VS_OUTPUT FireWallVS(float4 Pos: POSITION){
   ...
   if(MaterialDiffuse.a != 0 && MaterialDiffuse.a != 1)
   {
   		Out = AllFunc(FireWallNum,Pos,1,0.1,0.75,0.4,20);
	    Out.texCoord.x += 0.5;
   }
   return Out;
}
VS_OUTPUT SmokeWallVS(float4 Pos: POSITION){
   ...
   if(MaterialDiffuse.a != 0 && MaterialDiffuse.a != 1)
   {
   		Out = AllFunc(FireWallNum,Pos,1.5,0.1,0.5,0.4,20);
   }
   return Out;
}
