...
float morph_h : CONTROLOBJECT < string name = "ColorController_hsb.pmd"; string item = "乗算色相"; >;
float morph_s : CONTROLOBJECT < string name = "ColorController_hsb.pmd"; string item = "乗算彩度"; >;
float morph_b : CONTROLOBJECT < string name = "ColorController_hsb.pmd"; string item = "乗算明度"; >;
float morph_h_add : CONTROLOBJECT < string name = "ColorController_hsb.pmd"; string item = "加算色相"; >;
float morph_s_add : CONTROLOBJECT < string name = "ColorController_hsb.pmd"; string item = "加算彩度"; >;
float morph_b_add : CONTROLOBJECT < string name = "ColorController_hsb.pmd"; string item = "加算明度"; >;
float morph_add_si : CONTROLOBJECT < string name = "ColorController_hsb.pmd"; string item = "加算倍率"; >;
float morph_a : CONTROLOBJECT < string name = "ColorController_hsb.pmd"; string item = "透明度"; >;
...
float4 ColorRender_PS() : COLOR
{
	float4 pallet;
	//乗算
	pallet = tex2D(PalletSamp,float2(morph_h,1-morph_s))*(1-morph_b)*2;
	EdgeColor.rgb *= pallet.rgb;
    
    
    //加算
	pallet = tex2D(PalletSamp,float2(morph_h_add,1-morph_s_add))*morph_b_add*morph_add_scale;
	EdgeColor.rgb += pallet;
	
	EdgeColor.a *= 1-morph_a;
    return EdgeColor;
}
...
float4 BufferShadow_PS(BufferShadow_OUTPUT IN, uniform bool useTexture, uniform bool useSphereMap, uniform bool useToon) : COLOR
{
	...
	pallet = tex2D(PalletSamp,float2(morph_h,1-morph_s))*(1-morph_b)*2;
	Color.rgb *= pallet.rgb;
	ShadowColor.rgb *= pallet.rgb;
    
    //加算
	pallet = tex2D(PalletSamp,float2(morph_h_add,1-morph_s_add))*morph_b_add*morph_add_scale;
	Color.rgb += pallet;
	ShadowColor.rgb += pallet;
	
	//透明度
	Color.a *= 1-morph_a;
	ShadowColor.a *= 1-morph_a;
