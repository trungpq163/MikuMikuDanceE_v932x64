...
float morph_width : CONTROLOBJECT < string name = "(self)"; string item = "弾き幅"; >;
float morph_width_pow : CONTROLOBJECT < string name = "(self)"; string item = "弾き強さ"; >;
float morph_r_rot : CONTROLOBJECT < string name = "(self)"; string item = "右回転"; >;
float morph_l_rot : CONTROLOBJECT < string name = "(self)"; string item = "左回転"; >;
