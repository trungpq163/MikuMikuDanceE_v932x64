...
float4 Base_BufCpy_PS_1(float2 texCoord: TEXCOORD0) : COLOR {
	return tex2D(WorldBase1, texCoord);
}
float4 Base_BufCpy_PS_2(float2 texCoord: TEXCOORD0) : COLOR {
	return tex2D(WorldBase2, texCoord);
}
float4 Base_BufCpy_PS_3(float2 texCoord: TEXCOORD0) : COLOR {
	return tex2D(WorldBase3, texCoord);
}
float4 Base_BufCpy_PS_4(float2 texCoord: TEXCOORD0) : COLOR {
	return tex2D(WorldBase4, texCoord);
}
float4 Base_BufCpy_PS_5(float2 texCoord: TEXCOORD0) : COLOR {
...
> {
	...
	pass WorldBase1_buf < string Script = "Draw=Buffer;";>
	{
	    ...
	    PixelShader = compile ps_3_0 Base_BufCpy_PS_1();
	}
	pass WorldBase2_buf < string Script = "Draw=Buffer;";>
	{
	    ...
	    ALPHATESTENABLE=FALSE;
	    VertexShader = compile vs_3_0 Base_BufCpy_VS();
	    PixelShader = compile ps_3_0 Base_BufCpy_PS_2();
	}
	pass WorldBase3_buf < string Script = "Draw=Buffer;";>
	{
	    ...
	    ALPHATESTENABLE=FALSE;
	    VertexShader = compile vs_3_0 Base_BufCpy_VS();
	    PixelShader = compile ps_3_0 Base_BufCpy_PS_3();
	}
	pass WorldBase4_buf < string Script = "Draw=Buffer;";>
	{
	    ...
	    ALPHATESTENABLE=FALSE;
	    VertexShader = compile vs_3_0 Base_BufCpy_VS();
	    PixelShader = compile ps_3_0 Base_BufCpy_PS_4();
	}
	pass AlphaBase_buf < string Script = "Draw=Buffer;";>
	{
	    ...
	    ALPHATESTENABLE=FALSE;
	    VertexShader = compile vs_3_0 Base_BufCpy_VS();
	    PixelShader = compile ps_3_0 Base_BufCpy_PS_5();
	}
