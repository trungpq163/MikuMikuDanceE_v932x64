...
#define CONTROLLER_NAME "SS_Controller_0.pmx"
float3 ControllerPos : CONTROLOBJECT < string name = CONTROLLER_NAME; string item = "センター"; >;
float morph_spd : CONTROLOBJECT < string name = CONTROLLER_NAME; string item = "速度調節"; >;
float morph_width_x : CONTROLOBJECT < string name = CONTROLLER_NAME; string item = "範囲X"; >;
float morph_width_z : CONTROLOBJECT < string name = CONTROLLER_NAME; string item = "範囲Z"; >;
float morph_height : CONTROLOBJECT < string name = CONTROLLER_NAME; string item = "範囲Y"; >;
float morph_width_x_down : CONTROLOBJECT < string name = CONTROLLER_NAME; string item = "範囲X縮小"; >;
float morph_width_z_down : CONTROLOBJECT < string name = CONTROLLER_NAME; string item = "範囲Z縮小"; >;
float morph_height_down : CONTROLOBJECT < string name = CONTROLLER_NAME; string item = "範囲Y縮小"; >;
float morph_num : CONTROLOBJECT < string name = CONTROLLER_NAME; string item = "個数調節"; >;
float morph_lamp : CONTROLOBJECT < string name = CONTROLLER_NAME; string item = "点滅速度"; >;
float morph_patscale : CONTROLOBJECT < string name = CONTROLLER_NAME; string item = "ﾊﾟｰﾃｨｸﾙSi"; >;
float morph_rand : CONTROLOBJECT < string name = CONTROLLER_NAME; string item = "ゆらぎ"; >;

float morph_H : CONTROLOBJECT < string name = CONTROLLER_NAME; string item = "色相"; >;
float morph_S : CONTROLOBJECT < string name = CONTROLLER_NAME; string item = "彩度"; >;
float morph_B : CONTROLOBJECT < string name = CONTROLLER_NAME; string item = "明度"; >;
float morph_A : CONTROLOBJECT < string name = CONTROLLER_NAME; string item = "透明度"; >;
...
{
    float4 color = tex2D( Tex1Samp, IN.Tex );
    color.rgb *= ParticleColor;
    color.rgb *= 1+LightBoost;
    color.a *= IN.Alpha*1;
    
	float3 PalletColor = tex2D(PalletSamp,float2(morph_H,morph_S)).rgb*morph_B*2;
    color.rgb *= saturate(PalletColor);
    color.a *= 1-morph_A;
    
    color.rgb *= LightColor+0.5;
	if(use_spe)
	{
