...
//        TexColor.rgb = TexColor.r * float3(0.95,1,0.9);
        TexColor.rgb = TexColor.r * float3(1.0, 0.95, 0.9);
        TexColor.rgb = pow(TexColor.rgb*10,10);
        TexColor.rgb = saturate(TexColor.rgb)*0.5 + 0.5;
        if(spadd) {
    ...
    Color.rgb = lerp(Color.rgb,Color.rgb*MaterialToon,d);
