...
float morph_sca : CONTROLOBJECT < string name = "(OffscreenOwner)"; string item = "エッジ太さ"; >;
float morph_col : CONTROLOBJECT < string name = "(OffscreenOwner)"; string item = "エッジ濃さ"; >;
static float ShadowCol = 0.5 * morph_col;
static float EdgeScale = 0.5-morph_sca*0.5;
////////////////////////////////////////////////////////////////////////////////////////////////
//	ベース
//  full.fx ver1.4
//  作成: 舞力介入P
...
// 頂点シェーダ
VS_OUTPUT Basic_VS2(float4 Pos : POSITION, float3 Normal : NORMAL, float2 Tex : TEXCOORD0, uniform bool useTexture, uniform bool useSphereMap, uniform bool useToon)
{
    VS_OUTPUT Out = (VS_OUTPUT)0;
...
// ピクセルシェーダ
float4 Basic_PS2(VS_OUTPUT IN, uniform bool useTexture, uniform bool useSphereMap, uniform bool useToon) : COLOR0
{
    // スペキュラ色計算
    float3 HalfVector = normalize( normalize(IN.Eye) + -LightDirection );
    float3 Specular = pow( max(0,dot( HalfVector, normalize(IN.Normal) )), SpecularPower ) * SpecularColor;
...
// 不要なものは削除可
technique MainTec0 < string MMDPass = "object"; bool UseTexture = false; bool UseSphereMap = false; bool UseToon = false;string Script = 
        "RenderColorTarget0=;"
 ...
 >{
    ...
    pass DrawObject2 {
    	CULLMODE = CW;
        VertexShader = compile vs_2_0 Basic_VS2(false, false, false);
        PixelShader  = compile ps_2_0 Basic_PS2(false, false, false);
    }
}

technique MainTec1 < string MMDPass = "object"; bool UseTexture = true; bool UseSphereMap = false; bool UseToon = false;string Script = 
        "RenderColorTarget0=;"
	    "RenderDepthStencilTarget=;"
	    "Pass=DrawObject2;"
	    "Pass=DrawObject;"
 ...
 >{
    ...
    pass DrawObject2 {
    	CULLMODE = CW;
        VertexShader = compile vs_2_0 Basic_VS2(true, false, false);
        PixelShader  = compile ps_2_0 Basic_PS2(true, false, false);
    }
}

technique MainTec2 < string MMDPass = "object"; bool UseTexture = false; bool UseSphereMap = true; bool UseToon = false;string Script = 
        "RenderColorTarget0=;"
	    "RenderDepthStencilTarget=;"
	    "Pass=DrawObject2;"
	    "Pass=DrawObject;"
 ...
 >{
    ...
    pass DrawObject2 {
    	CULLMODE = CW;
        VertexShader = compile vs_2_0 Basic_VS2(false, true, false);
        PixelShader  = compile ps_2_0 Basic_PS2(false, true, false);
    }
}

technique MainTec3 < string MMDPass = "object"; bool UseTexture = true; bool UseSphereMap = true; bool UseToon = false;string Script = 
        "RenderColorTarget0=;"
	    "RenderDepthStencilTarget=;"
	    "Pass=DrawObject2;"
	    "Pass=DrawObject;"
 ...
 >{
    ...
    pass DrawObject2 {
    	CULLMODE = CW;
        VertexShader = compile vs_2_0 Basic_VS2(true, true, false);
        PixelShader  = compile ps_2_0 Basic_PS2(true, true, false);
    }
}

technique MainTec4 < string MMDPass = "object"; bool UseTexture = false; bool UseSphereMap = false; bool UseToon = true;string Script = 
        "RenderColorTarget0=;"
	    "RenderDepthStencilTarget=;"
	    "Pass=DrawObject2;"
	    "Pass=DrawObject;"
 ...
 >{
    ...
    pass DrawObject2 {
    	CULLMODE = CW;
        VertexShader = compile vs_2_0 Basic_VS2(false, false, true);
        PixelShader  = compile ps_2_0 Basic_PS2(false, false, true);
    }
}

technique MainTec5 < string MMDPass = "object"; bool UseTexture = true; bool UseSphereMap = false; bool UseToon = true;string Script = 
        "RenderColorTarget0=;"
	    "RenderDepthStencilTarget=;"
	    "Pass=DrawObject2;"
	    "Pass=DrawObject;"
 ...
 >{
    ...
    pass DrawObject2 {
    	CULLMODE = CW;
        VertexShader = compile vs_2_0 Basic_VS2(true, false, true);
        PixelShader  = compile ps_2_0 Basic_PS2(true, false, true);
    }
}

technique MainTec6 < string MMDPass = "object"; bool UseTexture = false; bool UseSphereMap = true; bool UseToon = true;string Script = 
        "RenderColorTarget0=;"
	    "RenderDepthStencilTarget=;"
	    "Pass=DrawObject2;"
	    "Pass=DrawObject;"
 ...
 >{
    ...
    pass DrawObject2 {
    	CULLMODE = CW;
        VertexShader = compile vs_2_0 Basic_VS2(false, true, true);
        PixelShader  = compile ps_2_0 Basic_PS2(false, true, true);
    }
}

technique MainTec7 < string MMDPass = "object"; bool UseTexture = true; bool UseSphereMap = true; bool UseToon = true;string Script = 
        "RenderColorTarget0=;"
	    "RenderDepthStencilTarget=;"
	    "Pass=DrawObject2;"
	    "Pass=DrawObject;"
 ...
 >{
    ...
    pass DrawObject2 {
    	CULLMODE = CW;
        VertexShader = compile vs_3_0 Basic_VS2(true, true, true);
        PixelShader  = compile ps_3_0 Basic_PS2(true, true, true);
    }
}
