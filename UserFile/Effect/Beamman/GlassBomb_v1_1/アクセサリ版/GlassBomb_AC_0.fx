...
float morph_Rot : CONTROLOBJECT < string name = CONTROLLER; string item = "回転速度"; >;
...
float morph_dist : CONTROLOBJECT < string name = CONTROLLER; string item = "歪み"; >;
...
float4x4 world_matrix : CONTROLOBJECT < string name = CONTROLLER;string item = "センター";>;
...
VS_OUTPUT BombVS(float4 Pos: POSITION,float2 Tex: TEXCOORD0,float3 Normal : NORMAL){
	...
	//初速
	float sca = saturate(r.z+morph_Spd)*10;
