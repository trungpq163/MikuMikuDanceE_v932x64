...
static float2 SampStep = (float2(blur+(1-blur_tr),blur+(1-blur_tr))/ViewportSize);
...
{   
	...
	float a = rlr.a;
	Color.rgb = lerp(Color.rgb,saturate(Color.rgb+0.2) * rlr.rgb * Color.a,saturate(a));
