...
float4 PS_DirectionalBlur( float2 Tex: TEXCOORD0 , uniform float rate) : COLOR {   
    float e, n = 0;
    float2 stex;
    float4 Color, sum = 0;
...
> {
    ...
    pass DirectionalBlur1 < string Script= "Draw=Buffer;"; > {
        ...
        PixelShader  = compile ps_3_0 PS_DirectionalBlur(0.7);
    }
    
    pass DirectionalBlur2 < string Script= "Draw=Buffer;"; > {
        AlphaBlendEnable = FALSE;
        VertexShader = compile vs_3_0 VS_passDraw();
        PixelShader  = compile ps_3_0 PS_DirectionalBlur(0.4);
    }
