////////////////////////////////////////////////////////////////////////////////////////////////
//
//  AutoLuminous for ikPolish
//  そぼろ さんの AutoLuminous Ver.4.2 を ikPolish用に改造したもの。
//
////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////
// ユーザーパラメータ
...
#else
	float lum = max(length(Color.rgb), 0.001);
	float lum2 = th + sqrt(max(0, (lum - th) * 0.5));
	Color.rgb = max(0, Color.rgb * min(1.0, lum2 / lum));
#endif
...
DoubleColor PS_DrawHighLight( float2 Tex: TEXCOORD0 ) {
    ...
    //元スクリーンの高輝度成分の抽出
    OrgColor = Degamma4(tex2Dlod(ScnSamp, float4(Tex, 0, 0)));
