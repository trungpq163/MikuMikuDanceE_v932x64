...
　頭ボーンにぶら下げた場合、アクセサリのzを調整して、
　頭ボーンの中心から鼻先にズラすとよりピントが正しく合うようになります。

- 細かい調整をしない場合、以下は不要。
4. ikBokehController.pmx を追加する。
5. モーフのボケ+/-でボケる量を調整する。
6. モーフのテストモードでボケる範囲が確認できます。
7. その他の調整を行う。
...
　ピント滑り
　　(※ ver0.18で、"ピント安定度"から"ピント滑り"に変更。値の意味を反転させた。)

　　ピント移動でオーバーシュートさせます。
　　ピントを動かし過ぎて元に戻す演出を行いたい場合は、滑りを上げます。
...
　2017/12/31 Ver 0.18c 　ピントが1フレーム遅れる問題を修正
　2017/09/30 Ver 0.18b 　玉ボケ強調の計算を変更
　2017/09/16 Ver 0.18a 　不具合対策

　2017/09/02 Ver 0.18
　　・高速化。
　　・ピント計算の見直し。
　　・画角変更でもピントの遅れを出すようにした。
　　　 - "ピント遅延"が大きい場合のみ。
　　・デフォルトでピントの遅れを安定させるようにした。
　　　 - モーフ名を"ピント安定度"から、"ピント滑り"に変更し、意味を逆転させた。
　2017/02/25 Ver 0.17
　　前ボケサイズの軽減機能追加。
　　パラメータの調整。
　　高速化。コードの整理。
