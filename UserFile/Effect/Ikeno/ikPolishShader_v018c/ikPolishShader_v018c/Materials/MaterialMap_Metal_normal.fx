...
#define MATERIALMAP_MAIN_FILENAME "metal_mat.png"		//ファイル名
const float MaterialMapLoopNum = 2;		// 繰り返し回数
...
// メイン法線マップ
#define NORMALMAP_MAIN_FILENAME "metal_n.png" //ファイル名
const float NormalMapMainLoopNum = 2;				//繰り返し回数
const float NormalMapMainHeightScale = 0.5;		//高さ補正 正で高くなる 0で平坦
