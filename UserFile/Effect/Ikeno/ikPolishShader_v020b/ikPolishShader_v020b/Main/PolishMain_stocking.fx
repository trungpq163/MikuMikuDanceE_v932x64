...
const float VelvetExponent = 0.2;			// 縁の大きさ
const float VelvetBaseReflection = 0.00;	// 正面での明るさ 
#define VELVET_MUL_COLOR		float3(1.00, 1.00, 1.00)	// 正面の色(乗算)
#define VELVET_MUL_RIM_COLOR	float3(0.10, 0.10, 0.10)	// 縁の色(乗算)
