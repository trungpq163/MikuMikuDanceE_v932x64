...
2. アクセサリの描画順序を調整する。
　基本的には、スカイドーム、パーティクルなど(カメラの先にあるもの)よりは後に、
...
　　※ 一般的にピント距離が後にあるほど、ボケない範囲は広くなります。
　　　裏返すと、ピント範囲が狭いことは対象が近くにあることを表します。
　　　ピント範囲を狭めることで、本物の風景をミニチュア風にする撮影方法があります。
...
　背景のコントラストを高くする。無地にしない。
　周囲の色や明るさが近いとボケたのが分かりにくいです。
