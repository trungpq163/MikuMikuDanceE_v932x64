...
const float Smoothness = 0.80;		// 自動設定しない場合の値。
...
#define SMOOTHNESSMAP_FILENAME "noise80_90.png"
const float SmoothnessMapLoopNum = 0.3;
...
const float NormalMapSubHeightScale = 0.1;		//高さ補正 正で高くなる 0で平坦
