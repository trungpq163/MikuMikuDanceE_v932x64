...
const float Smoothness = 0.95;		// 自動設定しない場合の値。

// 映り込み強度(0:映り込まない。1:映り込む。1以上の値も設定可能)
const float Intensity = 1.0;

// 非金属の垂直反射率
// 金属の場合は、色＝リフレクタンスとして扱う。ダイアモンドは0.17。
const float NonmetalF0 = 0.20;
...
// 材質マップのr,g,bには、Metalness、Smoothness、Intensityが格納されているものとする。
