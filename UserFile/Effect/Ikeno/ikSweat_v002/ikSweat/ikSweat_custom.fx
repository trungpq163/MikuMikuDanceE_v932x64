...
const float ParticleSize = 1.0;
// 軌跡が乾く速度(1未満にすること。1に近過ぎると飽和してフラットになる。)
const float DryRate = 0.86;
// 水滴の落下速度 (速過ぎると軌跡が途切れる)
const float FallSpeedRate = 1.0;
// 水滴の厚み (0.5～4.0程度。大きいほど厚い)
const float Thickness = 1.0;
// 半透明度: 1.0 (不透明)
const float MaterialAlpha = 0.05;
// 落下までの時間の加速度
...
// 水滴が落下するまでの最小時間
const float LifetimeMin = 10.0;
// 水滴が落下するまでの揺れ幅
// LifetimeMin ～ LifetimeMin+LifetimeFluctuation が落下までの間に落下する。
const float LifetimeFluctuation = 10.0;

// 落下した水滴が消滅するまでの時間
const float DurationMin = 30.0;
// 消滅するまでの時間の揺れ幅
