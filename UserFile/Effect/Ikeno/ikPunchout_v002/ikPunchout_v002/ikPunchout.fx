...
float3 AnchorPosition01 : CONTROLOBJECT < string name = "MaskAnchor01.x"; >;
float3 AnchorPosition02 : CONTROLOBJECT < string name = "MaskAnchor02.x"; >;
float3 AnchorPosition03 : CONTROLOBJECT < string name = "MaskAnchor03.x"; >;
float3 AnchorPosition04 : CONTROLOBJECT < string name = "MaskAnchor04.x"; >;
float3 AnchorPosition05 : CONTROLOBJECT < string name = "MaskAnchor05.x"; >;
float3 AnchorPosition06 : CONTROLOBJECT < string name = "MaskAnchor06.x"; >;
float3 AnchorPosition07 : CONTROLOBJECT < string name = "MaskAnchor07.x"; >;
float3 AnchorPosition08 : CONTROLOBJECT < string name = "MaskAnchor08.x"; >;

bool AnchorExist01 : CONTROLOBJECT < string name = "MaskAnchor01.x"; >;
bool AnchorExist02 : CONTROLOBJECT < string name = "MaskAnchor02.x"; >;
bool AnchorExist03 : CONTROLOBJECT < string name = "MaskAnchor03.x"; >;
bool AnchorExist04 : CONTROLOBJECT < string name = "MaskAnchor04.x"; >;
bool AnchorExist05 : CONTROLOBJECT < string name = "MaskAnchor05.x"; >;
bool AnchorExist06 : CONTROLOBJECT < string name = "MaskAnchor06.x"; >;
bool AnchorExist07 : CONTROLOBJECT < string name = "MaskAnchor07.x"; >;
bool AnchorExist08 : CONTROLOBJECT < string name = "MaskAnchor08.x"; >;

static float4 AnchorArray[] = {
	float4( AnchorPosition01, AnchorExist01),
	float4( AnchorPosition02, AnchorExist02),
	float4( AnchorPosition03, AnchorExist03),
	float4( AnchorPosition04, AnchorExist04),
	float4( AnchorPosition05, AnchorExist05),
	float4( AnchorPosition06, AnchorExist06),
	float4( AnchorPosition07, AnchorExist07),
	float4( AnchorPosition08, AnchorExist08),
};
...
VS_OUTPUT2 Anchor_VS(float4 Pos : POSITION, float2 Tex : TEXCOORD0)
{
	...
	float4 ppos = mul(float4(AnchorArray[i].xyz,1), matVP);
	...
	Pos.y *= -1;
	Pos.w = (j < MAX_ANCHOR_COUNT) * (s * ViewportSize.x > 3.0) * (AnchorArray[i].w > 0.1) * (ppos.z > 0.0);
