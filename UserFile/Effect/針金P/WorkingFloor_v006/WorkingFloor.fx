////////////////////////////////////////////////////////////////////////////////////////////////
//
//  WorkingFloor.fx ver0.0.6  モデルを地面に対して鏡像描画，床に仕事をさせます
//  作成: 針金P( 舞力介入P氏のfull.fx改変 )
//
////////////////////////////////////////////////////////////////////////////////////////////////
// ここのパラメータを変更してください

#define BothSidesMat  "1000-"       // α値0.999等で両面描画している材質リスト
...
// 鏡像エッジ頂点シェーダ
float4 MirrorEdge_VS(float4 Pos : POSITION) : POSITION 
{
    // ワールド座標変換
...
// オブジェクト描画用テクニック（PMDモデル用,両面描画材質）
technique MainTec4 < string MMDPass = "object"; string Subset = BothSidesMat; 
...
technique MainTec5 < string MMDPass = "object"; string Subset = BothSidesMat; 
...
technique MainTec6 < string MMDPass = "object"; string Subset = BothSidesMat;
...
technique MainTec7 < string MMDPass = "object"; string Subset = BothSidesMat;
...
// オブジェクト描画用テクニック（PMDモデル用,両面描画材質）
technique MainTecBS4  < string MMDPass = "object_ss"; string Subset = BothSidesMat;
                        bool UseTexture = false; bool UseSphereMap = false; bool UseToon = true; > {
    pass DrawMirrorObject {
...
technique MainTecBS5  < string MMDPass = "object_ss"; string Subset = BothSidesMat;
                        bool UseTexture = true; bool UseSphereMap = false; bool UseToon = true; > {
    pass DrawMirrorObject {
...
technique MainTecBS6  < string MMDPass = "object_ss"; string Subset = BothSidesMat;
                        bool UseTexture = false; bool UseSphereMap = true; bool UseToon = true; > {
    pass DrawMirrorObject {
...
technique MainTecBS7  < string MMDPass = "object_ss"; string Subset = BothSidesMat;
                        bool UseTexture = true; bool UseSphereMap = true; bool UseToon = true; > {
    pass DrawMirrorObject {
