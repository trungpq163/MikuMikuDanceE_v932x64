////////////////////////////////////////////////////////////////////////////////////////////////
//
//  ColorFilter_Contrast ver0.0.1  画面の色で輝度のコントラスト調整するエフェクト
//  作成: 針金P
//
////////////////////////////////////////////////////////////////////////////////////////////////
...
static float Power = clamp(AcsX * 0.001f * AcsSi, -1.0, 0.9999f);
#else
static float Power = clamp(AcsX * 0.05f, -1.0, 0.9999f);
#endif
