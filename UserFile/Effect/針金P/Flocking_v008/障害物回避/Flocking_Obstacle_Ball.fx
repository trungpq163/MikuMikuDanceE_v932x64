////////////////////////////////////////////////////////////////////////////////////////////////
//
// Flocking_Obstacle_Ball.fx  フロッキングアルゴリズム(障害物回避：球体)
//  作成: 針金P
//
////////////////////////////////////////////////////////////////////////////////////////////////
// ここのパラメータを変更してください
float AvoidanceFactor = 15.0;       // 回避度(大きくすると障害物との衝突回避度が大きくなる)
...
float4 Potential_PS(float2 texCoord: TEXCOORD0) : COLOR
{
    ...
    // 障害物の方向ベクトル
    float3 ObstacleAngle = normalize( AcsOffset - Pos0 );

    // 障害物までの距離
    float ObstacleLength = length( Pos0 - AcsOffset ) - AcsScaling;
