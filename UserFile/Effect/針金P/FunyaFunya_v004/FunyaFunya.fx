////////////////////////////////////////////////////////////////////////////////////////////////
//
//  FunyaFunya.fx ver0.0.4  ふにゃふにゃエフェクト
//  作成: 針金P( 舞力介入P氏のfull.fx改変 )
//
////////////////////////////////////////////////////////////////////////////////////////////////
// ここのパラメータを変更してください
float Amplitude = 1.0;         // 波の振幅
float WaveNumber = 0.5;        // 波数(大きくすると波形が小刻みになります)
float AngularFrequency = 3.0;  // 角周波数(大きくすると波の進行が速くなります)
...
{
   float theta = WaveNumber * Pos.y - AngularFrequency * time;

   Pos.x += Amplitude * sin(theta);
