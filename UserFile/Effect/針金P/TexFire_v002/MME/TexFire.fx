////////////////////////////////////////////////////////////////////////////////////////////////
//
//  TexFire.fx ver0.0.2 ビルボード＋テクスチャアニメの炎エフェクト
//  作成: 針金P
//
////////////////////////////////////////////////////////////////////////////////////////////////
// ここのパラメータを変更してください
...
float fireRadiateFactor = 1.3;  // 炎の拡がり度
float fireWvAmpFactor = 1.0;    // 炎の左右の揺らぎ振幅
float fireWvFreqFactor = 1.33;  // 炎の左右の揺らぎ周波数
float firePowAmpFactor = 0.12;  // 炎の明るさ揺らぎ振幅
float firePowFreqFactor = 10.0; // 炎の明るさ揺らぎ周波数
float fireTexMoveLimit = 0.02;  // オブジェクト移動に伴う炎の揺らぎ限界値(移動が大きく炎がボードからはみ出る場合はここを小さくする)

int FrameCount = 1; // 1フレームの炎テクスチャ更新数(60fpsで1, 30fpsで2ぐらいが多分ベスト)

float fireInitScaling = 1.0;  // 炎の初期スケール
float fireAveScaling = 1.0;   // 炎の平均スケール(モデル側で複数のスケール設定した場合の平均値)
