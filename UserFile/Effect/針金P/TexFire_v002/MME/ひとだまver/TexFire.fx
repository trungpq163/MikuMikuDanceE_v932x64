////////////////////////////////////////////////////////////////////////////////////////////////
//
//  TexFire.fx ver0.0.2 ビルボード＋テクスチャアニメの炎エフェクト(Corpse Candle Ver)
//  作成: 針金P
//
////////////////////////////////////////////////////////////////////////////////////////////////
// ここのパラメータを変更してください
...
#define FireColorTexFile   "palette4.png"   // 炎色palletテクスチャファイル名

//メラメラ感を決めるパラメータ,ここを弄れば見た目が結構代わる。
float fireDisFactor = 0.07; 
float fireSizeFactor = 4.8;
float fireShakeFactor = 0.4;

float fireRiseFactor = 6.0;     // 炎の上昇度
float fireRadiateFactor = 0.3;  // 炎の拡がり度
float fireWvAmpFactor = 1.0;    // 炎の左右の揺らぎ振幅
float fireWvFreqFactor = 1.3;   // 炎の左右の揺らぎ周波数
float firePowAmpFactor = 0.12;  // 炎の明るさ揺らぎ振幅
float firePowFreqFactor = 10.0; // 炎の明るさ揺らぎ周波数
...
float fireInitScaling = 1.0;  // 炎の初期スケール
float fireAveScaling = 1.0;   // モデル平均スケール(モデル側で複数のスケール設定した場合の平均値)

float ElasticFactor = 3.0;  // ボーン追従の弾性度(ここを1000以上にすると完全追従になる)
