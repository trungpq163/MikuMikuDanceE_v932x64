////////////////////////////////////////////////////////////////////////////////////////////////
//
//  HgSpotLight.fx ver0.0.1  スポットライト光源エフェクト(セルフシャドウなし)
//  作成: 針金P
//
////////////////////////////////////////////////////////////////////////////////////////////////
// パラメータ宣言
...
> = 0.8;
    ...
    #define OFFSCREEN_LIGHT "HgSL_Object.fxsub"
#else
    #define OFFSCREEN_LIGHT "HgSL_ObjectMMM.fxsub"
#endif
...
texture HgSL_DrawRT: OFFSCREENRENDERTARGET <
    string Description = "HgSpotLight.fxのモデルの点光源ライティング結果";
