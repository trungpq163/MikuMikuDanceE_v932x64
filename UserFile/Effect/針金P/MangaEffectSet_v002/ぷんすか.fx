////////////////////////////////////////////////////////////////////////////////////////////////
//
//  ぷんすか.fx ver0.0.2  漫画風表現エフェクト(ぷんすか)
//  作成: 針金P
//
////////////////////////////////////////////////////////////////////////////////////////////////
// ここのパラメータを変更してください

#define TexFile  "punsuka.png"   // 粒子に貼り付けるテクスチャファイル名
int ParticleCount = 16;    // 粒子の描画オブジェクト数
float ParticleSize = 0.7;  // 粒子大きさ
float ParticleSpeed = 0.6; // 粒子のスピード

float Rmin = 3.0;          // 配置半径最小値
float Rmax = 7.5;          // 配置半径最大値
