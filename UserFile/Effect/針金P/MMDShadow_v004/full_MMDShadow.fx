...
struct BufferShadow_OUTPUT {
    ...
    ////////////////////// MMDShadowに対応するにはこれを追加します //////////////////////
    // ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
    float4 ZCalcTex2 : TEXCOORD5;    // MMDShadow用Z値
    // ↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
    /////////////////////////////////////////////////////////////////////////////////////
...
BufferShadow_OUTPUT BufferShadow_VS(float4 Pos : POSITION, float3 Normal : NORMAL, float2 Tex : TEXCOORD0, float2 Tex2 : TEXCOORD1, uniform bool useTexture, uniform bool useSphereMap, uniform bool useToon)
{
    ...
    ////////////////////// MMDShadowに対応するにはこれを追加します //////////////////////
    // ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
    Out.ZCalcTex2 = mul( Pos, MMDShadow_GetLightWorldViewProjMatrix(parthf) );
    // ↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
    /////////////////////////////////////////////////////////////////////////////////////
...
float4 BufferShadow_PS(BufferShadow_OUTPUT IN, uniform bool useTexture, uniform bool useSphereMap, uniform bool useToon) : COLOR
{
    ...
    if( MMDShadow_Valid ){
        ...
        if( !any( saturate(TransTexCoord) - TransTexCoord ) ) {
            comp = MMDShadow_GetSelfShadowRate(TransTexCoord, IN.ZCalcTex2.z, parthf);
        }
