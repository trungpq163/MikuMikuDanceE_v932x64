////////////////////////////////////////////////////////////////////////////////////////////////
//
//  PostClip (PostClip_Bright.fx) ver0.0.1
//  既存のポストエフェクトを特定領域でクリップ（輝度でクリップ）
//  作成: 針金P
//
////////////////////////////////////////////////////////////////////////////////////////////////
// ここのパラメータを変更してください

// 輝度の初期閾値(MMEのみ,MMMはエフェクトプロパティで変更)
float InitThreshold = 0.8;
...
float  AcsTr   : CONTROLOBJECT < string name = "(self)"; string item = "Tr"; >;
    ...
    static float Threshold = clamp( degrees(AcsRx) + InitThreshold, 0.0f, 1.0f );
...
float4 PS_Clip( float2 Tex: TEXCOORD0 ) : COLOR
{
    ...
    // 輝度計算(NTSC系加重平均法)
    float v = 0.298912f * Color0.r + 0.586611f * Color0.g + 0.114478f * Color0.b;

    // このエフェクトのクリップ範囲
    float s = smoothstep(ThresholdMin, ThresholdMax, v);
