////////////////////////////////////////////////////////////////////////////////////////////////
//
//  Ninja_Line.fx ver0.0.4   分身の術(横一列)
...
{
   Pos.x += Length*((int)((time*Fps+Index*Step)%Num)-Num/2);
   return Pos;
}
...
float4 ColorRender_VS(float4 Pos : POSITION) : POSITION 
{
    ...
    // カメラ視点のビュー射影変換
    return mul( TransPos(Pos), ViewProjMatrix );
}
...
{
    // カメラ視点のワールドビュー射影変換
    return mul( TransPos(Pos), WorldViewProjMatrix );
}
