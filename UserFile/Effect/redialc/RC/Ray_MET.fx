...
#define ALBEDO_SUB_MAP_FILE "o.jpg"
...
#define NORMAL_MAP_FILE "o.jpg"

const float normalMapScale = 100.0;
const float normalMapLoopNum = 10.0;
...
#define SPECULAR_MAP_FILE "o.jpg"
...
const float3 emissive = float3(0.0, 1.0, 0.0);
