...
// B = Fixed Brightness
float3 GhostFlareParams = float3(8, 0.0, 2.0);
...
float4 GhostParams[16] = { 
	float4(1.0, 1.0, 1.0, 1.0), float4(4.0, 0.0, 1.0, 0.1), float4(1.0, 1.0, 1.0, 1.0), float4(1.0, 1.0, 1.0, 1.0),
...
static float3 OcclusionParams = float3(10, 20, 1000);
