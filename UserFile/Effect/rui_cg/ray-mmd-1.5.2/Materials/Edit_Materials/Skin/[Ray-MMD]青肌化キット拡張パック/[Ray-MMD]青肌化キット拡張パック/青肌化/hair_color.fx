...
float mR : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "hairR";>;
float mG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "hairG";>;
float mB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "hairB";>;
float mS : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "hairS";>;
