...
float mR : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "R";>;
float mG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "G";>;
float mB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "B";>;
float mS : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "S";>;
