...
#define CONTROLLER_NAME "color_controller.pmx"

float mR : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "eyeR";>;
float mG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "eyeG";>;
float mB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "eyeB";>;
float mS : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "eyeS";>;

static const float3 albedo = float3(2*mR, 2*mG, 2*mB) * (1-mS);
...
float mER : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "eyeR";>;
float mEG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "eyeG";>;
float mEB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "eyeB";>;
float mES : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "eyeS";>;

static const float3 emissive = float3(2*mER, 2*mEG, 2*mEB) * (1-mES);
const float3 emissiveBlink = 1.0;
const float  emissiveIntensity = 0.36;
...
#include "material_common_mono.fxsub"