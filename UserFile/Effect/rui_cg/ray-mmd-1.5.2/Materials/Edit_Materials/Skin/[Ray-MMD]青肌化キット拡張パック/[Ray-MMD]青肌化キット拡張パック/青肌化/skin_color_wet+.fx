...
float mR : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "skinR";>;
float mG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "skinG";>;
float mB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "skinB";>;
float mS : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "skinS";>;
...
#define SSS_SKIN_TRANSMITTANCE(x) exp((1 - saturate(x)) * float3(-37, -37, -37))
