...
float mR : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "metalR";>;
float mG : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "metalG";>;
float mB : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "metalB";>;
float mS : CONTROLOBJECT<string name=CONTROLLER_NAME; string item = "metalS";>;

static const float3 albedo = float3(1.2*mR, 1.2*mG, 1.2*mB) * (1-mS);
