...
#define NORMAL_MAP_FILE "../Transparent/zuikaku_eye.png"

const float normalMapScale = 1.0;
const float normalMapLoopNum = 2.10;
...
#define PARALLAX_MAP_FILE "../Transparent/zuikaku_eye.png"
...
const float3 emissive = 0.25;
const float3 emissiveBlink = 1.0;
const float  emissiveIntensity = 0.75;
