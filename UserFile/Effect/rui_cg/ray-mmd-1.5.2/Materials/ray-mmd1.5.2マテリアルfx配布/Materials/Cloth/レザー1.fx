...
#define NORMAL_MAP_FILE "../_MaterialMap/NM-Leather007.png"

const float normalMapScale = 1.2;
const float normalMapLoopNum = 15.0;
...
const float2 customAMapLoopNum = 1.0;
