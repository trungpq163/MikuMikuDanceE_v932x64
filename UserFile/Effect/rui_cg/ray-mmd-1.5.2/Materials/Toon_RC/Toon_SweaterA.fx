...
#define NORMAL_MAP_FILE "./Tex/S1.png"

const float normalMapScale = 2.5;
const float normalMapLoopNum = 6.0;

#define NORMAL_SUB_MAP_FROM 1
#define NORMAL_SUB_MAP_TYPE 0
#define NORMAL_SUB_MAP_UV_FLIP 0
#define NORMAL_SUB_MAP_FILE "./Tex/S1.png"
