...
#define NORMAL_MAP_FILE "./tex/Skin.png"
...
#define OCCLUSION_MAP_FILE "Skin.png"

const float occlusion = 1.0;
const float occlusionMapLoopNum = 0.0;
...
const float  emissiveIntensity = 1.00;
...
const float3 customB = float3(0.4, 0.35, 0.32);
