#define CONTROLLER_NAME "material_skin_face.pmx"
...
static const float3 albedo = mAlbedoColor +  float3(0.5,0.1,0.0);
...
#define NORMAL_MAP_FILE "skin.png"

static const float normalMapScale = 0.1 * (mNormalScale - 30);
static const float normalMapLoopNum = 30 * mNormalLoops;
