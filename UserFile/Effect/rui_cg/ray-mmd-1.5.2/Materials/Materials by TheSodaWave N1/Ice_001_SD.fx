...
#define ALBEDO_MAP_FILE "Ice_001_SD/Ice_001_COLOR2.jpg"
...
#define ALBEDO_SUB_MAP_FILE "Ice_001_SD/Ice_001_COLOR.jpg"

const float3 albedoSub = float3(255,255,255)/255;
const float2 albedoSubMapLoopNum = 1;

#define ALPHA_MAP_FROM 3
#define ALPHA_MAP_UV_FLIP 0
#define ALPHA_MAP_SWIZZLE 0
#define ALPHA_MAP_FILE "Ice_001_SD/Ice_001_COLOR.jpg"
...
#define NORMAL_MAP_FILE "Ice_001_SD/Ice_001_NRM.jpg"

const float normalMapScale = 2;
...
#define SPECULAR_MAP_FILE "Ice_001_SD/Ice_001_SPEC.jpg"

const float3 specular = 1;
...
#define OCCLUSION_MAP_FILE "Ice_001_SD/Ice_001_OCC.jpg"
...
#define PARALLAX_MAP_FILE "Ice_001_SD/Ice_001_DISP2.png"
...
#define CUSTOM_A_MAP_APPLY_SCALE 2
#define CUSTOM_A_MAP_FILE "Ice_001_SD/Ice_001_SSS.png"

const float customA = 0.46;
...
#define CUSTOM_B_MAP_FILE "Ice_001_SD/Ice_001_DISP.png"

#define SSS_SKIN_TRANSMITTANCE(x) exp((1 - saturate(x)) * float3(-20, -0, -0))

const float3 customB = SSS_SKIN_TRANSMITTANCE(0.98);
