...
#define ALBEDO_MAP_FILE "Jade_Soda/Marble_Blu_003_COLOR3.png"
...
const float3 albedoSub = float3(169,236,174)/255;
...
#define CUSTOM_A_MAP_UV_FLIP 3
#define CUSTOM_A_MAP_COLOR_FLIP 0
#define CUSTOM_A_MAP_SWIZZLE 0
#define CUSTOM_A_MAP_APPLY_SCALE 0
#define CUSTOM_A_MAP_FILE "Jade_Soda/Marble_Blu_003_SSS.png"
...
#define CUSTOM_B_MAP_FILE "Jade_Soda/Marble_Blu_003_SSS.png"
#define SSS_SKIN_TRANSMITTANCE(x) exp((1 - saturate(x)) * float3(-94, -4, -25))

const float3 customB = SSS_SKIN_TRANSMITTANCE(0.80);
