...
#define NORMAL_MAP_FILE "Fabric02_N by 2gou.bmp"

const float normalMapScale = 1.0;
const float normalMapLoopNum = 7.0;

#define NORMAL_SUB_MAP_FROM 1
#define NORMAL_SUB_MAP_TYPE 0
#define NORMAL_SUB_MAP_UV_FLIP 0
#define NORMAL_SUB_MAP_FILE "Fabric02_N by 2gou.bmp"

const float normalSubMapScale = 2.0;
const float normalSubMapLoopNum = 7.0;
