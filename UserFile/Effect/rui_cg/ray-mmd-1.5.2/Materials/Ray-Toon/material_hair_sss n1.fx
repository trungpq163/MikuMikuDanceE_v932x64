...
#define NORMAL_MAP_FILE "hair4.bmp"

const float normalMapScale = 0.75;
const float normalMapLoopNum = 1.5;

#define NORMAL_SUB_MAP_FROM 1
#define NORMAL_SUB_MAP_TYPE 0
#define NORMAL_SUB_MAP_UV_FLIP 0
#define NORMAL_SUB_MAP_FILE "hair4.bmp"

const float normalSubMapScale = 0.45;
const float normalSubMapLoopNum = 2.5;
...
const float2 customBMapLoopNum = 9.0;
