#define CONTROLLER_NAME "material_lumi_notex.pmx"
#include "../Editor/Glass/material_editor.fxsub"

#define ALBEDO_MAP_FROM 7
...
static const float metalness = 2 * mMetalness + 1.0;
...
static const float3 emissive = mEmissiveColor + 1.0;
static const float emissiveBlink = mEmissiveBlink; 
static const float emissiveIntensity = 3 * (mEmissiveIntensity - 1) + 2.0;
