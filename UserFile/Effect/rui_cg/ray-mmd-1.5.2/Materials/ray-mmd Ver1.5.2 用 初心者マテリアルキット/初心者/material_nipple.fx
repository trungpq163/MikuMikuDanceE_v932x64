#define CONTROLLER_NAME "material_nipple.pmx"
...
static const float normalMapScale = -1 * (mNormalScale - 1) - 2.5;
static const float normalMapLoopNum = -1 * (mNormalLoops - 1) + 30;
...
static const float normalSubMapLoopNum = -10 * (mNormalSubLoops - 1) + 30;
