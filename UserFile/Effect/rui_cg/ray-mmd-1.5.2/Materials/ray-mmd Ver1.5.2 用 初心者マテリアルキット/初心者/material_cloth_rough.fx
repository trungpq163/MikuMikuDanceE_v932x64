#define CONTROLLER_NAME "material_cloth_rough.pmx"
...
static const float normalMapScale = -1 * (mNormalScale - 1) - 2.0;
static const float normalMapLoopNum = 2 * (mNormalLoops - 1) + 19;
