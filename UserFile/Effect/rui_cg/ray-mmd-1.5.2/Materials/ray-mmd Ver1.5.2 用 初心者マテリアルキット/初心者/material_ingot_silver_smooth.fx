#define CONTROLLER_NAME "material_ingot_silver.pmx"
...
static const float3 albedo = mAlbedoColor - 1 + float3(0.95, 0.93, 0.88);
...
#define ALBEDO_SUB_MAP_APPLY_SCALE 2
...
static const float metalness = 0.01 * mMetalness + 0.99;
