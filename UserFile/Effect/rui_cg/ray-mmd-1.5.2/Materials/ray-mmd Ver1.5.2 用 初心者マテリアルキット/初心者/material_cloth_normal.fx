#define CONTROLLER_NAME "material_cloth_normal.pmx"
...
static const float normalMapScale = -1 * (mNormalScale - 1) - 0.5;
static const float normalMapLoopNum = 2 * (mNormalLoops - 1) + 50;
...
static const float smoothness = (mSmoothness - 1) + 0.5;
...
static const float metalness = mMetalness * 10;
