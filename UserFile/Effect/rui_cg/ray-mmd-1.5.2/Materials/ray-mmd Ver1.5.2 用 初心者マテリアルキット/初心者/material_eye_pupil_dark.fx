#define CONTROLLER_NAME "material_eye_pupil_dark.pmx"
...
static const float3 albedo = mAlbedoColor * 0.5;
...
static const float3 albedoSub = mMelanin * 3.0;
...
static const float emissiveIntensity = 0.1 * (mEmissiveIntensity - 1) + 0.039;
