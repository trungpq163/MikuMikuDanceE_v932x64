#define CONTROLLER_NAME "material_nuruteka.pmx"
#include "../Editor/ClearCoat/material_editor.fxsub"

#define ALBEDO_MAP_FROM 3
#define ALBEDO_MAP_UV_FLIP 0
#define ALBEDO_MAP_APPLY_SCALE 3
...
#define ALBEDO_SUB_MAP_APPLY_SCALE 3
#define ALBEDO_SUB_MAP_FILE "albedo.png"

static const float3 albedoSub = mMelanin * 5;
...
static const float normalSubMapScale = -2 * (mNormalSubScale - 1) - 0.5;
...
static const float smoothness = 0.01 * mSmoothness + 0.99;
static const float smoothnessMapLoopNum = mSmoothnessLoops;

#define METALNESS_MAP_FROM 0
#define METALNESS_MAP_UV_FLIP 0
#define METALNESS_MAP_SWIZZLE 2
#define METALNESS_MAP_APPLY_SCALE 3
#define METALNESS_MAP_FILE "metalness.png"

static const float metalness = 0.7 * mMetalness + 0.3;
...
static const float3 specular = (mSpecularColor - 1) + 0.5;
...
static const float emissiveIntensity = 0.2 * (mEmissiveIntensity - 1);
...
static const float customA = 0.2 * mCustomA + 0.8;
...
#define SSS_SKIN_TRANSMITTANCE(x) exp((1 - saturate(x)) * float3(0, 0, 0))
