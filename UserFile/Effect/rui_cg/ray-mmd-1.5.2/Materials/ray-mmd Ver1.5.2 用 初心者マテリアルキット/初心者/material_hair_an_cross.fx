#define CONTROLLER_NAME "material_hair_an.pmx"
...
static const float3 albedoSub = mMelanin * 2 + 0.01;
...
#define NORMAL_MAP_FILE "NormalMap/NMhair_cross.png"

static const float normalMapScale = -2 * (mNormalScale - 1) - 2.0;
...
static const float normalSubMapScale = -1 * (mNormalSubScale - 1) - 1.0;
...
static const float metalness = mMetalness * 2;
...
static const float customA = 0.5 + mCustomA;
...
static const float2 customBMapLoopNum = 10 * mCustomBLoops;
