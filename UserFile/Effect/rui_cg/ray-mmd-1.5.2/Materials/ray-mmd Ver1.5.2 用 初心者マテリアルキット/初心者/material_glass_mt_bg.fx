#define CONTROLLER_NAME "material_glass_mt_bg.pmx"
...
static const float smoothness = 0.9 + 0.1 * mSmoothness;
...
static const float metalness = 0.3 + 0.7 * mMetalness;
...
static const float3 customB = 0.1 + mCustomBColor;
