#define CONTROLLER_NAME "material_cloth_shine.pmx"
#include "../Editor/Cloth/material_editor.fxsub"

#define ALBEDO_MAP_FROM 3
#define ALBEDO_MAP_UV_FLIP 0
#define ALBEDO_MAP_APPLY_SCALE 2
...
#define NORMAL_MAP_FILE "NormalMap/NMcloth.png"

static const float normalMapScale = -2 * (mNormalScale - 1) - 0.2;
static const float normalMapLoopNum = 5 * (mNormalLoops - 1) + 97;
...
static const float smoothness = (mSmoothness - 1) + 0.6;
...
static const float metalness = mMetalness * 50 + 0.01;
