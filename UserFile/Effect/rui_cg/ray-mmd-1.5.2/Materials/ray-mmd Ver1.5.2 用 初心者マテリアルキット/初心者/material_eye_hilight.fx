#define CONTROLLER_NAME "material_eye_hilight.pmx"
...
static const float normalMapScale = -0.1* (mNormalScale - 1) - 1.01;
...
static const float metalness = 2 * mMetalness + 0.001;
...
static const float3 emissive = mEmissiveColor + float3(10, 10, 10);
static const float emissiveBlink = mEmissiveBlink; 
static const float emissiveIntensity = (mEmissiveIntensity - 1) + 0.8;
