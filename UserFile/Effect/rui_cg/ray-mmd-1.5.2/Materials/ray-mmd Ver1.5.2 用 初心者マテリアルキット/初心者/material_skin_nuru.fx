#define CONTROLLER_NAME "material_skin_nuru.pmx"
...
static const float3 albedoSub = mMelanin * 1.5 + 0.4;
...
static const float normalMapScale = 0.2 + (mNormalScale - 1) / 5;;
static const float normalMapLoopNum = 20 + 10 * mNormalLoops;
...
static const float smoothness = 0.2 * mSmoothness + 0.8;
...
static const float metalness = mMetalness * 2.0 + 0.1;
...
static const float3 emissive = mEmissiveColor +  float3(0.20,0,0);
