...
#define ALBEDO_MAP_FILE "../../_Tex/{%[CNQ[H6RRXNWCB2{)KW6N.png"
...
const float3 albedoSub = float3(1.0, 1.0, 1.0);
...
#define NORMAL_MAP_FILE "../../_Tex/²¼.bmp"
...
#define NORMAL_SUB_MAP_FILE "../../_Tex/ÀÙË¿·¨Ïß2.png"

const float normalSubMapScale = 0.5;
const float normalSubMapLoopNum = 2;
