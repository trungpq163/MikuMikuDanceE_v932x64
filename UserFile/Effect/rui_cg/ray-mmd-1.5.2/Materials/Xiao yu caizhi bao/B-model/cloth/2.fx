...
#define NORMAL_MAP_UV_FLIP 1
#define NORMAL_MAP_FILE "../Tex/2.png"

const float normalMapScale = 2;
const float normalMapLoopNum = 0.1;

#define NORMAL_SUB_MAP_FROM 1
#define NORMAL_SUB_MAP_TYPE 0
#define NORMAL_SUB_MAP_UV_FLIP 0
#define NORMAL_SUB_MAP_FILE "../_Tex/²¼.bmp"

const float normalSubMapScale = 15;
const float normalSubMapLoopNum = 40.0;

#define SMOOTHNESS_MAP_FROM 5
...
const float3 customB = float3(0.0,0.0, 0.0);
const float2 customBMapLoopNum = 1.0;

#include "../_Tex/material_common_2.0.fxsub"