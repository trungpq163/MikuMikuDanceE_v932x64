...
#define NORMAL_SUB_MAP_FILE "../_Tex/NM-Fabric01.png"

const float normalSubMapScale = 2;
const float normalSubMapLoopNum = 10.0;
...
const float3 customB = float3(1.0, 1.0, 1.0);
