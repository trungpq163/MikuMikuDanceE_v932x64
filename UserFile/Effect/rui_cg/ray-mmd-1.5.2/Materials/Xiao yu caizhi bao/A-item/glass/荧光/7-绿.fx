...
const float3 albedo = float3(0.0,1,0.0);
...
const float3 albedoSub = float3(1,1,1);
...
const float3 emissive = float3(0.0,1,0.0);
const float3 emissiveBlink = 1.0;
const float  emissiveIntensity = 0.1;
