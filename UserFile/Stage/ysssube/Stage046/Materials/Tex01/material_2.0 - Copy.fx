...
const float normalMapScale = 0.1;
const float normalMapLoopNum = 1.0;

#define NORMAL_SUB_MAP_FROM 1
#define NORMAL_SUB_MAP_TYPE 0
#define NORMAL_SUB_MAP_UV_FLIP 0
#define NORMAL_SUB_MAP_FILE "Tex01_NORM.png"

const float normalSubMapScale = 0.5;
...
#define SMOOTHNESS_MAP_FILE "Tex01_ROU.tga"

const float smoothness = 0.2;
const float smoothnessMapLoopNum = 1.0;

#define METALNESS_MAP_FROM 0 // tạo sáng lên
#define METALNESS_MAP_UV_FLIP 0
#define METALNESS_MAP_SWIZZLE 0
#define METALNESS_MAP_APPLY_SCALE 0
#define METALNESS_MAP_FILE "Tex01_Metal.tga"

const float metalness = 0.3;
const float metalnessMapLoopNum = 1.0;

#define SPECULAR_MAP_FROM 0
#define SPECULAR_MAP_TYPE 0 //(1)
#define SPECULAR_MAP_UV_FLIP 0
#define SPECULAR_MAP_SWIZZLE 0
#define SPECULAR_MAP_APPLY_SCALE 1 // (0)
#define SPECULAR_MAP_FILE "Tex01_SPEC.tga"

const float3 specular = 0.5; // 0.5
const float2 specularMapLoopNum = 1.0;

#define OCCLUSION_MAP_FROM 3 // 0
#define OCCLUSION_MAP_TYPE 0
#define OCCLUSION_MAP_UV_FLIP 0
#define OCCLUSION_MAP_SWIZZLE 0
#define OCCLUSION_MAP_APPLY_SCALE 1 // 0 
#define OCCLUSION_MAP_FILE "Tex01_AO.tga"

const float occlusion = 1.0; //1.0
